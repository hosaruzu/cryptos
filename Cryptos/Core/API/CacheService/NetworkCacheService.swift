...
final class NetworkCacheServiceImpl: NetworkCacheService {
    ...
    init(userDefaults: UserDefaults = .standard, urlCache: URLCache = .shared) {
    ...
    func cacheData(from urlRequest: URLRequest, cachedURLResponse: CachedURLResponse) {
        ...
        userDefaults.set(900 + Date.timeIntervalSinceReferenceDate, forKey: responseCacheKey(urlString: urlString))
    }
